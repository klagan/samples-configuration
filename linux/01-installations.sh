...
apt -y full-upgrade
apt autoremove
apt install -y ufw openvpn openresolv vim lynx lynis rkhunter apt-listbugs needrestart fail2ban clamav clamav-daemon nginx docker.io samba-client netdiscover cifs-utils nfs-common
